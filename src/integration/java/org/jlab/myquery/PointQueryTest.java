...
public class PointQueryTest {
  ...
  public void doTest() throws IOException, InterruptedException {
    ...
    HttpRequest request =
        HttpRequest.newBuilder()
            .uri(URI.create("http://localhost:8080/myquery/point?m=docker&c=channel1&t=2019-08-13"))
            .build();
  ...
  public void basicUsage() throws IOException, InterruptedException {
    ...
    String endPoint =
        "http://localhost:8080/myquery/point?m=docker&c=channel1&t=2019-08-12+00:00:00.2925281&f=6";
